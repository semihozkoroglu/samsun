...
public class HoloCircularProgressBar extends View {
    ...
    private ProgressAnim mAnimator;
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (isReverse)
            canvas.drawArc(mCircleBounds, 270, mOverrdraw ? 360 : -(360 - progressRotation), false,
                    mProgressColorPaint);
        else
    ...
    public class ProgressAnim extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {
            HoloCircularProgressBar.this.setProgress(interpolatedTime);
        }
    }
}